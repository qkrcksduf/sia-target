...
public class JpaResultMapper extends ResultMapper {
    ...
    static {
        ...
        PRIMITIVE_TO_BOX_TYPE_MAP.put(org.locationtech.jts.geom.Point.class, org.locationtech.jts.geom.Point.class);
        PRIMITIVE_TO_BOX_TYPE_MAP.put(UUID.class, UUID.class);
    }
